...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['2 containers', 'alice-rt runtime (45ms start)', '0.25 vCPU / 512 MB each', 'Community support'] },
  { name: 'Pro', price: '$79/mo', features: ['50 containers', 'alice-rt + alice-rt-wasm (5ms start)', 'Auto-scaling (1-10 replicas)', 'Multi-region deploy', '10,000 API calls/hr', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited containers', 'Custom runtime images', 'Auto-scaling (1-1000)', 'Dedicated clusters', 'SLA 99.99%', 'Dedicated support'] },
];
